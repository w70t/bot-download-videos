...
TRANSLATIONS = {
    'ar': {
        ...
        'invite_gate_period_locked': '🔒 **ادعُ صديقاً جديداً لتكمل التحميل!**\n\nيتطلّب البوت دعوة جديدة كل **{days}** يوم للاستمرار بالتحميل مجاناً.\n✅ يُفتح لك تلقائياً بمجرد انضمام صديق حقيقي عبر رابطك.\n\n🔗 **رابطك:**\n`{link}`\n\n👥 أصدقاؤك حتى الآن: **{count}**',
        'invite_gate_period_locked_nolink': '🔒 **ادعُ صديقاً جديداً لتكمل التحميل!**\n\nيتطلّب البوت دعوة جديدة كل **{days}** يوم للاستمرار بالتحميل.\n👇 اضغط زر «ادعُ أصدقاءك» بالأسفل للحصول على رابطك.',
    ...
    'en': {
        ...
        'invite_gate_period_locked': '🔒 **Invite a new friend to keep downloading!**\n\nThe bot requires a new invite every **{days}** day(s) to keep downloading for free.\n✅ It unlocks automatically the moment a real friend joins through your link.\n\n🔗 **Your link:**\n`{link}`\n\n👥 Your friends so far: **{count}**',
        'invite_gate_period_locked_nolink': '🔒 **Invite a new friend to keep downloading!**\n\nThe bot requires a new invite every **{days}** day(s) to keep downloading.\n👇 Tap the “Invite Friends” button below to get your link.',
