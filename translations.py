...
TRANSLATIONS = {
    'ar': {
        ...
        'consent_prompt': '⚠️ **شروط استخدام البوت**\n\n📥 هذا البوت مخصّص لتحميل الفيديوهات من مواقع التواصل الاجتماعي فقط.\n\n🔞 يُمنع منعاً باتاً تحميل أي محتوى إباحي أو مخل بالآداب.\n🚫 أي مخالفة = **حظر فوري ودائم**.\n\nللمتابعة، اضغط «✅ أوافق» لتأكيد موافقتك على الشروط.',
        'btn_consent_agree': '✅ أوافق على الشروط',
        'consent_thanks': '✅ تم تسجيل موافقتك',
    ...
    'en': {
        # Basic Messages
        'welcome': '╭─────────────────╮\n   ✦ 𝗩𝗜𝗗𝗘𝗢 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗥 ✦\n╰─────────────────╯\n\n🌟 Welcome **{name}** 🌟\nto the **Ultimate Downloader** 🏆\n\n🌐 **Supported platforms:**\n▸ YouTube ▸ TikTok ▸ Instagram\n▸ Facebook ▸ Snapchat ▸ X\n▸ Pinterest ▸ Reddit ▸ Threads\n\n💎 **Features:**\n🎬 Up to Full HD quality\n🚀 Upload up to 2GB\n⏱️ Videos up to 4 hours\n🎵 MP3 audio download\n⚡ Instant resend for cached clips\n\n⚠️ **Important notice:**\n🔞 This bot is for downloading videos from social media only.\nDownloading adult or explicit content is **strictly forbidden**, and violators are **banned immediately**.\n\n━━━━━━━━━━━━━━━\n📥 Just send **any video link**… we\'ll handle the rest! ✨',
        'choose_language': '🌍 **اختر لغتك**\nChoose Your Language',
        ...
        'consent_prompt': '⚠️ **Bot Terms of Use**\n\n📥 This bot is only for downloading videos from social media.\n\n🔞 Downloading any adult or explicit content is strictly forbidden.\n🚫 Any violation = **immediate permanent ban**.\n\nTo continue, tap "✅ I Agree" to accept the terms.',
        'btn_consent_agree': '✅ I Agree to the Terms',
        'consent_thanks': '✅ Your consent has been recorded',
