...
TRANSLATIONS = {
    'ar': {
        ...
        'story_unavailable': '⏳ **الستوري غير متاح**\n\nالستوري يعيش ٢٤ ساعة فقط — يبدو أنه انتهى، أو أن الحساب خاص.\nجرّب رابط ستوري حديث من حساب عام.',
    ...
    'en': {
        ...
        'story_unavailable': '⏳ **Story unavailable**\n\nStories only last 24 hours — this one seems to have expired, or the account is private.\nTry a recent story link from a public account.',
