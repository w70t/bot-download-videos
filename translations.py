...
TRANSLATIONS = {
    'ar': {
        ...
        'link_preview': '🎬 **{title}**\n\n{details}\n📥 **اختر نوع التحميل:**',
        'preview_duration': '⏱️ المدة: {duration}',
        'preview_platform': '🌐 المنصة: {platform}',
        ...
        'invite_gate_locked': '🔒 **عذراً، للاستمرار بالتحميل ادعُ صديقاً 🎁**\n\nتحميلك **مجاني** — لفتح المزيد ادعُ أصدقاءك لتجربة البوت، بثلاث خطوات فقط:\n\n**1)** اضغط زر **📤 مشاركة الرابط** بالأسفل ⬇️\n**2)** اختر صديقاً أو قروباً وأرسِل له الرابط\n**3)** بمجرّد أن يفتح صديقك البوت من رابطك — **يُفتح لك التحميل فوراً وتلقائياً** ✅\n\n🎁 كل صديق ينضم يفتح لك **{per}** تحميل إضافي.\n\n🔗 **رابطك الخاص للدعوة** (تقدر تنسخه يدوياً أيضاً):\n`{link}`\n\n👥 عدد من انضمّ عبر رابطك: **{count}**',
        'invite_gate_locked_nolink': '🔒 **عذراً، للاستمرار بالتحميل ادعُ صديقاً 🎁**\n\nتحميلك **مجاني** — لفتح المزيد ادعُ أصدقاءك لتجربة البوت، بثلاث خطوات فقط:\n\n**1)** اضغط زر **📤 مشاركة الرابط** بالأسفل ⬇️\n**2)** اختر صديقاً أو قروباً وأرسِل له الرابط\n**3)** بمجرّد أن يفتح صديقك البوت من رابطك — **يُفتح لك التحميل فوراً وتلقائياً** ✅\n\n🎁 كل صديق ينضم يفتح لك **{per}** تحميل إضافي.',
        'invite_gate_period_locked': '🔒 **عذراً، للاستمرار بالتحميل ادعُ صديقاً واحداً 🎁**\n\nتحميلك **مجاني بالكامل** — كل ما عليك دعوة **صديق واحد** لتجربة البوت، بثلاث خطوات فقط:\n\n**1)** اضغط زر **📤 مشاركة الرابط** بالأسفل ⬇️\n**2)** اختر صديقاً أو قروباً وأرسِل له الرابط\n**3)** بمجرّد أن يفتح صديقك البوت من رابطك — **يُفتح لك التحميل فوراً وتلقائياً** ✅\n\nوبعدها تحمّل بحريّة لمدة **{days}** أيام كاملة، ثم دعوة جديدة… وهكذا 🔄\n\n🔗 **رابطك الخاص للدعوة** (تقدر تنسخه يدوياً أيضاً):\n`{link}`\n\n👥 عدد من انضمّ عبر رابطك: **{count}**',
        'invite_gate_period_locked_nolink': '🔒 **عذراً، للاستمرار بالتحميل ادعُ صديقاً واحداً 🎁**\n\nتحميلك **مجاني بالكامل** — كل ما عليك دعوة **صديق واحد** لتجربة البوت، بثلاث خطوات فقط:\n\n**1)** اضغط زر **📤 مشاركة الرابط** بالأسفل ⬇️\n**2)** اختر صديقاً أو قروباً وأرسِل له الرابط\n**3)** بمجرّد أن يفتح صديقك البوت من رابطك — **يُفتح لك التحميل فوراً وتلقائياً** ✅\n\nوبعدها تحمّل بحريّة لمدة **{days}** أيام كاملة، ثم دعوة جديدة… وهكذا 🔄',
        ...
        'post_unavailable': '🔒 **المنشور غير متاح**\n\nهذا المنشور من حساب خاص أو تم حذفه من المنصة، لذا يتعذّر تحميله.\nتأكد أن المنشور عام ثم أعد المحاولة.',
    ...
    'en': {
        ...
        'preview_duration': '⏱️ Duration: {duration}',
