...
TRANSLATIONS = {
    'ar': {
        ...
        'threads_deleted': '🚫 **منشور ثريدز غير متاح**\n\nثريدز يقول إن هذا الرابط لم يعد يشير لمنشور — غالباً حُذف أو صار حسابه خاصاً.\nجرّب رابطاً آخر، وإن كان المنشور ظاهراً عندك فانسخ رابطه من جديد.',
    ...
    'en': {
        ...
        'threads_deleted': '🚫 **Threads post unavailable**\n\nThreads reports that this link no longer points to a post — it was most likely deleted, or its account became private.\nTry another link, and if the post still shows for you, copy its link again.',
