...
TRANSLATIONS = {
    'ar': {
        ...
        'file_too_large': '⚠️ **الملف كبير جداً**\n\n📊 الحجم · {size} MB\n🔒 الحد الأقصى · {max} MB (سقف تلجرام للبوتات)',
        'shrinking': '🗜️ **الملف كبير ({size} MB) — جاري تحويله إلى H.264 لتصغيره**\n\n⏳ قد يستغرق وقتاً مع مقاطع 4K',
        ...
        'fb_story_login': '🔒 **ستوري فيسبوك يتطلّب تسجيل دخول**\n\nفيسبوك لا يعرض الستوري إلا للحسابات المسجّلة — حتى رابط المشاركة يُحوَّل لصفحة الدخول، فيتعذّر تحميله.\n\n💡 المنشورات والريلز والفيديوهات العامة تعمل عادياً.',
        ...
        'threads_deleted': '🚫 **رابط المشاركة لم يعد صالحاً**\n\nثريدز نفسه يقول إن هذا الرابط لا يشير لمنشور — إمّا حُذف المنشور أو صار حسابه خاصاً، أو انتهت صلاحية رابط المشاركة.\n\n✅ **الحل:** افتح المنشور في تطبيق ثريدز، واضغط «⋯» ← **نسخ الرابط**، وأرسل الرابط الطويل الذي يبدأ بـ `threads.com/@…/post/…`\nهذا الرابط لا تنتهي صلاحيته أبداً.',
        'story_unavailable': '⏳ **تعذّر تحميل الستوري**\n\nالستوري يعيش ٢٤ ساعة فقط، فالغالب أنه انتهى — أو أن الحساب خاص.\nإن كان الستوري جديداً وحسابه عام، أعد المحاولة بعد دقيقة.',
    ...
    'en': {
        ...
        'file_too_large': '⚠️ **File too large**\n\n📊 Size · {size} MB\n🔒 Maximum · {max} MB (Telegram bot limit)',
        'shrinking': '🗜️ **File is large ({size} MB) — converting to H.264 to shrink it**\n\n⏳ May take a while for 4K clips',
        ...
        'fb_story_login': '🔒 **Facebook stories require login**\n\nFacebook only shows stories to signed-in accounts — even a share link redirects to the login page, so it cannot be downloaded.\n\n💡 Public posts, reels and videos work normally.',
        ...
        'threads_deleted': '🚫 **This share link is no longer valid**\n\nThreads itself reports that this link points to no post — the post was deleted, its account became private, or the share link expired.\n\n✅ **Fix:** open the post in the Threads app, tap «⋯» → **Copy link**, and send the long link starting with `threads.com/@…/post/…`\nThat link never expires.',
        'story_unavailable': '⏳ **Could not download the story**\n\nStories only last 24 hours, so it has most likely expired — or the account is private.\nIf the story is recent and the account is public, try again in a minute.',
