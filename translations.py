...
TRANSLATIONS = {
    'ar': {
        ...
        'downloads_paused': '⏸️ **التحميل متوقف مؤقتاً**\n\nأوقفت الإدارة التحميل حالياً. حاول لاحقاً.',
    ...
    'en': {
        ...
        'downloads_paused': '⏸️ **Downloads are paused**\n\nThe admin has temporarily paused downloads. Try again later.',
