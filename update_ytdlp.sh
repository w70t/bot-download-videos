...
# بصمة Chrome 99 المستخدمة لخطة Facebook البديلة مختبرة مع curl_cffi 0.15.x.
# إبقاء القيد منفصلاً عن PKGS مهم: عناصر PKGS أسماء حزم صافية تُستخدم في
# pip show وتقارير الإصدارات، بينما هذا المتطلب خاص بعملية التثبيت.
