...
# منطق الوصف نقيّ (بلا pyrogram/قاعدة بيانات) فأُخرج لوحدة مستقلّة تُختبر
# مباشرةً. الأسماء تبقى كما هي حتى لا تتغيّر مواضع الاستدعاء في bot.py.
from media_caption import (
    _PLATFORM_TITLE_LABELS, _looks_like_media_id, _clean_media_title,
    _COUNTRY_AR, _country_label, _build_source_lines, _build_media_caption,
)
