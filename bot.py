...
# اليوم. وأياً كان مصدر الرابط، يمرّ أخيراً على snapchat_clean_rendition الذي
# يحوّل رندر المشاركة 27 (اللوقو محروق داخل الصورة) إلى الرندر النظيف 1034.
...
# لغة واجهة الحساب — إشارة أقرب لأصل صاحبه من مركز البيانات
_LANG_AR = {
    'ar': 'العربية', 'en': 'الإنجليزية', 'es': 'الإسبانية', 'fr': 'الفرنسية',
    'de': 'الألمانية', 'tr': 'التركية', 'pt': 'البرتغالية', 'ru': 'الروسية',
    'it': 'الإيطالية', 'nl': 'الهولندية', 'id': 'الإندونيسية', 'ms': 'الماليزية',
    'hi': 'الهندية', 'ur': 'الأردية', 'fa': 'الفارسية', 'ja': 'اليابانية',
    'ko': 'الكورية', 'zh': 'الصينية', 'th': 'التايلاندية', 'vi': 'الفيتنامية',
    'pl': 'البولندية', 'sv': 'السويدية', 'el': 'اليونانية', 'he': 'العبرية',
}
...
def _snap_settings_view():
    ...
    text = (
        ...
        "التغطية **59/59** في آخر عيّنة مفحوصة. وإن لم توجد نسخة نظيفة لمقطع "
        "بعينه يرجع البوت لنسخة اللوقو بدل أن يفشل التحميل."
    )
    kb = InlineKeyboardMarkup([
